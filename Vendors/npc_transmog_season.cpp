...
- Complete: %0
- ScriptName: 'npc_transmog_season'
- Comment: N/A
<--------------------------------------------------------------------------->
*/
enum arenarating 
			...
			switch(uiAction)
			{
				case 0:
					if (Player->GetArenaPersonalRating(ARENA_TEAM_TYPE) >= arenarating ||
						...
						Player->GetArenaPersonalRating(ARENA_TEAM_TYPE) >= arenarating)
					{
						m_session->SendListInventory(Creature->GetGUID(), 1500080);
				...
				case 1:
					if (Player->GetArenaPersonalRating(ARENA_TEAM_TYPE) >= arenarating1 ||
						...
						Player->GetArenaPersonalRating(ARENA_TEAM_TYPE) >= arenarating1)
					{
						m_session->SendListInventory(Creature->GetGUID(), 1500081);
						Player->PlayerTalkClass->SendCloseGossip();
					}else
					{
				...
				case 2:
					if (Player->GetArenaPersonalRating(ARENA_TEAM_TYPE) >= arenarating2 ||
						...
						Player->GetArenaPersonalRating(ARENA_TEAM_TYPE) >= arenarating2)
					{
						m_session->SendListInventory(Creature->GetGUID(), 1500082);
						Player->PlayerTalkClass->SendCloseGossip();
						}else
					{
				...
				case 3:
					if (Player->GetArenaPersonalRating(ARENA_TEAM_TYPE) >= arenarating3 ||
						...
						Player->GetArenaPersonalRating(ARENA_TEAM_TYPE) >= arenarating3)
					{
						m_session->SendListInventory(Creature->GetGUID(), 1500083);
						Player->PlayerTalkClass->SendCloseGossip();
						}else
					{
				...
				case 4:
					if (Player->GetArenaPersonalRating(ARENA_TEAM_TYPE) >= arenarating4 ||
						Player->GetArenaPersonalRating(ARENA_TEAM_TYPE) >= arenarating4 ||
						Player->GetArenaPersonalRating(ARENA_TEAM_TYPE) >= arenarating4)
					{
						m_session->SendListInventory(Creature->GetGUID(), 1500084);
						Player->PlayerTalkClass->SendCloseGossip();
						}else
					{
