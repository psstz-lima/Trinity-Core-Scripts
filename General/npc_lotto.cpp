...
class npc_lotto : public CreatureScript
{
    public:
        ...
        bool OnGossipHello(Player* player, Creature* creature)
        {
			...
			creature->Whisper("You dont have enough Lottery Tickets", LANG_UNIVERSAL, player, true);
        ...
        switch (action)
		    ...
		    case GOSSIP_ACTION_INFO_DEF+1:
				creature->Whisper("Greetings competitor! Thank you for purchasing your Lottery ticket, please be sure to check your numbers against our database, for your chance to win a stunning 200 gold coins!", LANG_UNIVERSAL, player, true);
